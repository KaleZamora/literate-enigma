...
def smb_menu():
    ...
    while flag != 0:
        ...
        if yn == "y":
            ...
            subprocess.call(r"powershell.exe Enable-WindowsOptionalFeature -Online -FeatureName 'SMB1Protocol'")
            subprocess.call(r"powershell.exe Get-WindowsOptionalFeature -Online -FeatureName 'SMB1Protocol'")
